    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 fixed inset-y-0 left-0 bg-slate-900/80 backdrop-blur-xl border-r border-white/5 z-50 flex flex-col transition-transform duration-300" 
            ...
            <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                <a href="/dashboard" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300"
                   :class="isRoute('/dashboard') ? 'bg-blue-500/10 text-blue-500 border-l-2 border-blue-500' : 'text-gray-400 hover:bg-white/5 hover:text-gray-200'">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                    <span class="font-medium">Dashboard</span>
                </a>
                <a href="/detect" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300"
                   :class="isRoute('/detect') ? 'bg-blue-500/10 text-blue-500 border-l-2 border-blue-500' : 'text-gray-400 hover:bg-white/5 hover:text-gray-200'">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
                    <span class="font-medium">Manual Detect</span>
                </a>
                <a href="/scan" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300"
                   :class="isRoute('/scan') ? 'bg-blue-500/10 text-blue-500 border-l-2 border-blue-500' : 'text-gray-400 hover:bg-white/5 hover:text-gray-200'">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                    <span class="font-medium">Active Scan</span>
                </a>
